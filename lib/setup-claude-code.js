...
export async function setupClaudeCode(answers) {
  ...
  try {
    ...
    try {
      ...
      spinner.fail('Claude Code not installed');
      console.log(chalk.yellow('\n⚠️  Please install Claude Code first:'));
      console.log(chalk.cyan('   macOS/Linux: curl -fsSL https://claude.ai/install.sh | sh'));
      console.log(chalk.cyan('   Windows: Download from https://claude.ai/code'));
